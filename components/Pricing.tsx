...
const Pricing = () => {
  ...
  const qaTiers = [
    {
      id: 'test-automation',
      name: t('pricing.qa.automation.name'),
      subtitle: t('pricing.qa.automation.subtitle'),
      features: [
        t('pricing.qa.automation.feature1'),
        t('pricing.qa.automation.feature2'),
        t('pricing.qa.automation.feature3'),
        t('pricing.qa.automation.feature4'),
        t('pricing.qa.automation.feature5'),
        t('pricing.qa.automation.feature6'),
        t('pricing.qa.automation.feature7'),
        t('pricing.qa.automation.feature8'),
      ],
      highlighted: false,
    },
    {
      id: 'manual-qa-wcag',
      name: t('pricing.qa.manual.name'),
      subtitle: t('pricing.qa.manual.subtitle'),
      features: [
        t('pricing.qa.manual.feature1'),
        t('pricing.qa.manual.feature2'),
        t('pricing.qa.manual.feature3'),
        t('pricing.qa.manual.feature4'),
        t('pricing.qa.manual.feature5'),
        t('pricing.qa.manual.feature6'),
        t('pricing.qa.manual.feature7'),
        t('pricing.qa.manual.feature8'),
      ],
      highlighted: true,
      badge: t('pricing.qa.manual.badge'),
    },
    {
      id: 'performance-cicd',
      name: t('pricing.qa.performance.name'),
      subtitle: t('pricing.qa.performance.subtitle'),
      features: [
        t('pricing.qa.performance.feature1'),
        t('pricing.qa.performance.feature2'),
        t('pricing.qa.performance.feature3'),
        t('pricing.qa.performance.feature4'),
        t('pricing.qa.performance.feature5'),
        t('pricing.qa.performance.feature6'),
        t('pricing.qa.performance.feature7'),
        t('pricing.qa.performance.feature8'),
      ],
      highlighted: false,
    },
  ]
  ...
  return (
    <div className="py-20 w-full" id="pricing">
      ...
      {/* QA Services */}
      <h2 className="text-xl md:text-2xl font-bold text-center text-white mb-8">
        {t('pricing.qaServicesHeading')}
      </h2>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto px-4 mb-16">
        {qaTiers.map((tier, index) => (
          <motion.div
            key={tier.id}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
